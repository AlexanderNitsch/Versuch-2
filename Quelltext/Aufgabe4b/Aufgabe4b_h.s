...
; File          : Aufgabe4b_h.s														*
; Description   : main program for exercise 4 part b) 							   	*
;************************************************************************************
     	
		GET         ADUC7026.s			 			; include file ADUC7026.s 
		AREA 		exercise4b_h, CODE, READONLY	; declaration of code segment
...
set7  	mmr GP4CON,0x00000000	    ;configure Port 4.x in GPIO mode	
		...
		; ========================== 5. Include your code	
	  	...
	  	GET	Aufgabe4b_30.s			; <= put name of your code(for example Aufgabe4b_50.s) after GET directive
