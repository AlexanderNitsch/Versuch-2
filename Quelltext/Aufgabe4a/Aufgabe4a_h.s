...
; File          : Aufgabe4a_h.s														*
; Description   : main program for exercise 4 part a) 							   	*
;************************************************************************************
     	
		GET         ADUC7026.s			 			; include file ADUC7026.s 
		AREA 		exercise4a_h, CODE, READONLY	; declaration of code segment
...
$Label	mmr  $Register, $Value
		...
		; ========================== 2. Configure PLL (2.61 MHz) with POWCON write sequence
		...
		; ----- POWCON : PC:000, active mode; 
		ldr		r6,=POWCON		 	;load the address of MMR POWCON into r6
		mov		r2,#0x04			;load user value into r2, CD:100, CPU clock = 2.61MHz
		str		r2,[r6]				;write value 0x04 to MMR POWCON
...
set4  	mmr PWMDAT0,0x02			;PWM switching period, unsigned 16-bit
...
set7  	mmr GP4CON,0x00000000	    ;configure Port 4.x in GPIO mode	
		...
		; ========================== 5. Include your code	
	  	...
	  	GET	Aufgabe4a.s				; <= put name of your code(for example Aufgabe4a.s) after GET directive
