...
N_sinus EQU 579  
		...
		AREA 		exercise5_h, CODE, READONLY		; declaration of code segment 
...
set4  	mmr PWMDAT0,0x0A			;PWM switching period, unsigned 16-bit 
...
set7  	mmr GP4CON,0x00000000	    ;configure Port 4.x in GPIO mode	
		...
		; ========================== 5. Include your code	
	  	...
	  	GET	SineGen.s				; <= put name of your code(for example SineGen.s) after GET directive
